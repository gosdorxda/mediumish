...
<div class="mainheading homecover forauthor" 
     <?php if ($authorheaderbg) { ?> style="background-image:url(<?php echo $authorheaderbg; ?>);" <?php } ?> >
	<div class="row post-top-meta authorpage  justify-content-md-center  justify-content-lg-center">
        ...
        <a target="_blank" 
        href="<?php echo esc_url( get_the_author_meta('user_url') ) ; ?>">
        ...
        <?php if ($youtube) { ?>
		<a target="_blank" href="<?php echo esc_url( $youtube ); ?>"><i class="fa fa-youtube"></i></a> &nbsp;
        <?php } ?>
